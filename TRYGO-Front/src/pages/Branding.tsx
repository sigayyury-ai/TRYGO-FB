        ...
        <div className="flex flex-1 items-center justify-center px-4">
          <div className="text-center">
            ...
            <p className="text-blue-700 text-lg max-w-xl mx-auto">
              We are planning to add a Branding page in Q3 2025
            </p>

            <p className="mt-4 max-w-md mx-auto text-blue-800 text-base leading-relaxed">
              Get professional branding materials in minutes. Our AI creates
              custom texts and images tailored for your startup.
            </p>
