...
const RegenerateHypothesesMarketResearchForm: FC = () => {
...
Response must be in human-readable format.`);
  ...
  const { regenerateHypothesesMarketResearch } = useHypothesesMarketResearchStore();
...
export default RegenerateHypothesesMarketResearchForm;
