...
exports.generateSceneDescription = void 0;
const openai_1 = __importDefault(require("openai"));
const env_js_1 = require("../../config/env.js");
let openaiClient = null;
function getOpenAIClient() {
    if (!openaiClient) {
        if (!env_js_1.env.openAiApiKey) {
            throw new Error("OpenAI API key is not configured");
        }
        openaiClient = new openai_1.default({ apiKey: env_js_1.env.openAiApiKey });
    }
    return openaiClient;
}
/**
 ...
 */
async function generateSceneDescription(request) {
    ...
    const model = env_js_1.env.openAiModel || "gpt-4o";
...
exports.generateSceneDescription = generateSceneDescription;
