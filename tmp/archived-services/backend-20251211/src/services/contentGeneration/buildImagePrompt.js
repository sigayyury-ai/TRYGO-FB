...
exports.buildImagePrompt = void 0;
/**
 ...
 */
function buildImagePrompt(sceneDescription, variant = "hero") {
    ...
    return {
        prompt,
        negativePrompt: "text, letters, words, numbers, captions, typography, logos, ui elements, watermarks, memes, infographics, low quality, noisy texture, overexposed lighting, unrealistic anatomy, plastic skin, graphical elements, design overlays",
